...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG.song.endsWith('Old'))
		{
			...
			Lib.application.window.title = "Friday Night Funkin': This GC's Insanity | " + newName + legacycheck + ' | ' + autor;
		}
		else
		{
			newName = SONG.song;
			...
			Lib.application.window.title = "Friday Night Funkin': This GC's Insanity | " + newName + ' | ' + autor;
		}
		if(isWarp){
			var warpText:String = "?";
			...
			Lib.application.window.title = "Friday Night Funkin': This GC's Insanity | " + secretName + ' | ' + secretAutor;
		}
	...
	override function closeSubState()
	{
		if (paused)
		{
			...
			if(cpuControlled){
				timeBar.createFilledBar(0xFF000000, 0xFFff4040);
				timeBar.numDivisions = 800;
			}
			else{
				timeBar.createFilledBar(0xFF000000, 0xFF0023cc);
				timeBar.numDivisions = 800;
			}
			...
			notes.forEachAlive(function(daNote:Note)
			{
				...
				if (!daNote.mustPress && daNote.wasGoodHit && !daNote.hitByOpponent && !daNote.ignoreNote)
				{
					...
					else if (!daNote.noAnimation)
					{
						...
						/*
						else if (daNote.noteType == 'healthdrainfuni')
						{
							private var defaulthealthdrain = healthDrain;
							healthDrain = 0.1;
							wait(0.2);
							healthDrain = defaulthealthdrain;
						}
						*/
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String)
	{
		switch (eventName)
		{
			case 'Change Window Title':
				// fuck change property we using change window title event :fire:
				var Title:String = Std.string(value1);
				var Reset:String = Std.string(value2);
				if (value2 == "0") {
					Lib.application.window.title = "Friday Night Funkin': This GC's Insanity | " + newName + ' | ' + autor;
				}
				else if (value2 == "1") {
					Lib.application.window.title = value1;
				}
				else {
					trace("Don't forget to set a 0/1 value!");
				}
			case 'Hey!':
				var value:Int = 2;
			...
			case 'Triggers Unyappable':
				...
				if (!Math.isNaN(triggerMR)){
					switch (triggerMR)
					{
						...
						case 0.5:
							dad.alpha = 1;
							titleText.text = 'Unyappable(Level 1)';
							autorText.text = 'Mr. KYS VS Rosebloom';
						...
						case 11: //BOWSER START
							switch(triggerMR2){
								...
								case 4:
									titleText.text = 'Unyappable(Level 3)';
									autorText.text = 'ZVII VS Rosebloom';
									triggerEventNote('Change Character', '1', 'koopa');
									var weanose:Float;
									weanose = dad.y;
									dad.alpha = 1;
						...
						case 17:
							switch(triggerMR2){
								...
								case 2:
									...
									titleText.text = 'Unyappable(Level 4)';
									autorText.text = 'This GC VS Rosebloom';
			...
			case 'Triggers Intrusive Thoughts': // HERE COMES THE MADNESS HAHAHAHAHA
				...
				switch (trigger)
				{
					...
					case 5:
						// why the fuck is this here its empty - Data
					case 6:
						FOLLOWCHARS = false;
						ZOOMCHARS = false;
	...
	override function stepHit()
	{
		...
		if (curStage == 'virtual' && ClientPrefs.noVirtual)
		{
			if (curStep >= 1296) {
				if (curStep % 4 == 0) {
					triggerEventNote("Change Window Title", "", "1");
				}
				else if (curStep % 4 == 4) {
					triggerEventNote("Change Window Title", "", "1");
				}
			}
			switch (curStep)
			{
